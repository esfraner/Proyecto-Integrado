...
$response = false;
if ($stmt->execute([$postdata->id, $postdata->nombreCompleto, $postdata->fechaNacimiento, $postdata->edad, $postdata->lugarNacimiento, $postdata->paisNacimiento, $postdata->demarcacion, $postdata->foto, $postdata->equipo])) {
  $response = true;
}
echo($response);
